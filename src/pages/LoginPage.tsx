        ...
        <div className="w-full h-screen bg-surface flex overflow-hidden">
                ...
                <div className="max-w-md w-full mx-auto flex flex-col h-full justify-center">
                    ...
                    <div className="space-y-6 mt-16 sm:mt-0">
                        <div className="space-y-2">
                            <h1 className="text-3xl font-bold font-serif text-text-primary">Welcome back</h1>
                    ...
                    <div className="text-center mt-6">
                        <p className="text-sm text-text-secondary">
                            ...
                            <Link to="/register" className="text-primary hover:underline font-medium hover:text-primary-hover transition-colors">
                                Sign up
                            </Link>
                        </p>
                    </div>
            ...
            <div className="hidden lg:block w-1/2 relative bg-black h-full">
                <div className="absolute inset-0">
                    <FaultyTerminal {...TERMINAL_CONFIG} />
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-black/30 pointer-events-none" />

                <div className="absolute bottom-12 left-12 right-12 text-white z-10 pointer-events-none p-12">
                    <h2 className="text-4xl font-bold mb-4 font-serif">Build faster, together</h2>
                    <p className="text-white/70 text-lg max-w-md">Seamless automation for high-performing teams.</p>
                </div>
            </div>
        </div>
    );
